...
--
-- Host: localhost
-- Generation Time: Sep 12, 2014 at 02:07 PM
...
(5, 852, 'manali', 97876767, 'jbhh', 'jbjb', 120),
(5, 855, 'manali', 97876767, 'jbhh', 'jbjb', 120),
...
('manali', 'mn', 'jh', 'manali', 'jbzb', 'jhjdhdjj', 94415151, 'snsn', 'gmail.com', ' ', 0, ''),
('javiya', 'manali', 'manali', 'mnnnnn', 'jhjj', 'utgygyfy', 9765, 'jnjnjbh', 'gmail.com', ' ', 0, ''),
('mnnnnnn', 'bhvbvb', 'mhjb', 'bbh', 'jbjb', 'hhhvv', 98765, 'jknvdb', 'gmail.com', ' rajkotw', 98784, 'india'),
('manali', 'jav', 'jav', 'manali', 'javiya', 'nbnb', 61111212, 'nn', 'gmail.com', ' nmbn', 360062, 'jb');
